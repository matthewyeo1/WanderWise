...
// in ww_code/test/trip_planner_test.dart.
...
import 'package:ww_code/storage/itinerary_service.dart' as _i3;
import 'package:ww_code/user/auth_service.dart' as _i5;
...
class MockItineraryService extends _i1.Mock implements _i3.ItineraryService {
  MockItineraryService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<List<Map<String, dynamic>>> loadItineraryItems(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #loadItineraryItems,
          [userId],
  ...
  @override
  _i4.Future<void> updateItinerary(
    String? userId,
    Map<String, dynamic>? itinerary,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> deleteItinerary(
    String? userId,
    String? docId,
  ) =>
      (super.noSuchMethod(
...
/// A class which mocks [AuthServiceItinerary].
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthServiceItinerary extends _i1.Mock
    implements _i5.AuthServiceItinerary {
  MockAuthServiceItinerary() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Future<void> updateUserData(_i2.User? user) => (super.noSuchMethod(
        Invocation.method(
          #updateUserData,
          [user],
        ),
